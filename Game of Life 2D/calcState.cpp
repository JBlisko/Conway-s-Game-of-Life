...
// Functions
void findNeigh(vector<int> X, vector<int> Y, int i, bool& E, bool& NE, bool& N, bool& NW, bool& W, bool& SW, bool& S, bool& SE,
...
void vecCheck(vector<int> X, vector<int> Y, int x, int y, bool& contained);

void calcState(vector<int>& X, vector<int>& Y)
{
    ...
    for (int i = 0; i < min(X.size(), Y.size()); i++) {
        ...
        E = 0, NE = 0, N = 0, NW = 0, W = 0, SW = 0, S = 0, SE = 0,
            EE = 0, NEE = 0, NENE = 0, NEN = 0, NN = 0, NWN = 0, NWNW = 0, NWW = 0,
            WW = 0, SWW = 0, SWSW = 0, SWS = 0, SS = 0, SES = 0, SESE = 0, SEE = 0;

        findNeigh(X, Y, i, E, NE, N, NW, W, SW, S, SE, EE, NEE, NENE, NEN, NN, NWN, NWNW, NWW, WW, SWW, SWSW, SWS, SS, SES, SESE, SEE);

        /*
        cout << E << " " << NE << " " << N << " " << NW << " " << W << " " << SW << " " << S << " " << SE << " " << endl
            << EE << " " << NEE << " " << NENE << " " << NEN << " " << NN << " " << NWN << " " << NWNW << " " << NWW << endl
            << " " << WW << " " << SWW << " " << SWSW << " " << SWS << " " << SS << " " << SES << " " << SESE << " " << SEE;
        system("pause");
        */
...
void findNeigh(vector<int> X, vector<int> Y, int i, bool& E, bool& NE, bool& N, bool& NW, bool& W, bool& SW, bool& S, bool& SE,
    ...
    bool& SWS, bool& SS, bool& SES, bool& SESE, bool& SEE)
{
    for (int n = 0; n < min(X.size(), Y.size()); n++)
    {
